...
const Blog = () => {
    return (
        ...
        <div className='md:mx-12 mt-12 '>
            <div className=' text-start border rounded-xl m-10 p-10'>
                <h2 className='text-cyan-500 text-3xl py-4'>What is the purpose of react router?</h2>
            ...
            <div className='text-start border rounded-xl m-10 p-10'>
                <h2 className='text-cyan-500 text-3xl py-6'>How does context api work?</h2>
            ...
            <div className='text-start border rounded-xl m-10 p-10'>
                <h2 className='text-cyan-500 text-3xl py-6'>Explain useRef?</h2>
